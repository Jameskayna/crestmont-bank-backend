    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('support', 'Support agent'), ('compliance', 'Compliance officer'), ('admin', 'Administrator'), ('superadmin', 'Super administrator')], default='customer', max_length=20)),
